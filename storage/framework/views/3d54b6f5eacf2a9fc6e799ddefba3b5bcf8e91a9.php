...
<?php endif; ?>
        ...
        <?php echo $__env->make('LaravelLogger::partials.scripts', ['activities' => $userActivities], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                ...
                <div class="row">
                    <div class="col-xs-12 col-12">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item">
                                <?php echo $__env->make('LaravelLogger::logger.partials.activity-table', ['activities' => $userActivities], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            </li>
                        </ul>
                        <br />
                    </div>
