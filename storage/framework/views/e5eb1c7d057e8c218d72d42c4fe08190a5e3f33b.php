      ...
      <div class="col-lg-10 offset-lg-1">
        ...
        <div class="card">
          ...
          <div class="card-header text-white <?php if($user->activated == 1): ?> bg-success <?php else: ?> bg-danger <?php endif; ?>">
            <div style="display: flex; justify-content: space-between; align-items: center;">
              ...
              <div class="float-right">
                <a href="<?php echo e(route('users')); ?>" class="btn btn-info btn-sm float-right" data-toggle="tooltip" data-placement="left" title="<?php echo trans('usersmanagement.tooltips.back-users'); ?>">
          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-sm-4 col-md-6">
                ...
                <p class="text-center text-left-tablet">
                  ...
                  <?php if($user->email): ?>
                    <br />
                    <span class="text-center" data-toggle="tooltip" data-placement="top" title="<?php echo trans('usersmanagement.tooltips.email-user', ['user' => $user->email]); ?>">
                ...
                <?php if($user->profile): ?>
                  <div class="text-center text-left-tablet mb-4">
                    ...
                    <a href="/users/<?php echo e($user->id); ?>/edit" class="btn btn-sm btn-warning" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('usersmanagement.editUser')); ?>">
                      <i class="fas fa-pencil-alt fa-fw" aria-hidden="true"></i> <span class="hidden-xs hidden-sm hidden-md"> <?php echo e(trans('usersmanagement.editUser')); ?> </span>
                    </a>
            ...
            <div class="col-sm-7">
              <span data-toggle="tooltip" data-placement="top" title="<?php echo trans('usersmanagement.tooltips.email-user', ['user' => $user->email]); ?>">
                <?php echo e(HTML::mailto($user->email, $user->email)); ?>
