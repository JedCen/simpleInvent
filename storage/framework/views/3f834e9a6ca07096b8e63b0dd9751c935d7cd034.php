                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <span id="card_title">
                                <?php echo e(trans('usersmanagement.showing-all-users')); ?>

                            </span>

                            <div class="btn-group nav-pills btn-group-xs">
                                <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <i class="fa fa-ellipsis-v fa-fw" aria-hidden="true"></i>
                                    <span class="sr-only">
                                        <?php echo e(trans('usersmanagement.users-menu-alt')); ?>
...
<?php $__env->startSection('footer_scripts'); ?>
    <?php if(($users->count() > config('usersmanagement.datatablesJsStartCount')) && config('usersmanagement.enabledDatatablesJs')): ?>
