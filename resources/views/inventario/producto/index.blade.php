                ...
                <div class="card-header">
                    ...
                    <div class="float-right">
                        <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                            {!! HTML::icon_link(URL::to(route('producto.create')), 'fa fa-plus-circle', ' Agregar
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group">
                                        {!! HTML::icon_link(URL::to(route('producto.edit', $product->id)), 'fas
                                        fa-edit','', array('class' => 'btn btn-info btn-sm mr-3', 'data-toggle' =>
                                        'tooltip',
                                        'title' => 'Editar producto')) !!}

                                        @role('admin')
                                        {!! Form::model($product, array('action' => array('ProductoController@destroy',
                                        $product->id), 'method' => 'DELETE', 'data-toggle' => 'tooltip', 'title' =>
                                        'Eliminar producto permanete')) !!}
                                        {!! Form::hidden('_method', 'DELETE') !!}

                                        {!! Form::button('<i class="fa fa-trash fa-fw" aria-hidden="true"></i>',
