<?php $__env->startSection('template_title'); ?>
  Showing Deleted User <?php echo e($user->name); ?>
        ...
        <div class="card">
          ...
          <div class="card-header bg-danger text-white">
            <div style="display: flex; justify-content: space-between; align-items: center;">
              ...
              <?php echo app('translator')->getFromJson('usersmanagement.usersDeletedPanelTitle'); ?>

              <div class="float-right">
                <a href="/users/deleted/" class="btn btn-light btn-sm float-right" data-toggle="tooltip" data-placement="left" title="<?php echo app('translator')->getFromJson('usersmanagement.usersBackDelBtn'); ?>">
                  <i class="fa fa-fw fa-mail-reply" aria-hidden="true"></i>
                  <span class="sr-only">
                    <?php echo app('translator')->getFromJson('usersmanagement.usersBackDelBtn'); ?>
                  </span>
                </a>
              </div>
            </div>
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-sm-4 offset-sm-2 col-md-2 offset-md-3">
                <img src="<?php if($user->profile->avatar_status == 1): ?> <?php echo e($user->profile->avatar); ?> <?php else: ?> <?php echo e(Gravatar::get($user->email)); ?> <?php endif; ?>" alt="<?php echo e($user->name); ?>" id="" class="rounded-circle center-block mb-3 mt-4 user-image">
              </div>
                ...
                <?php if($user->profile): ?>
                  <div class="text-center text-left-tablet mb-4">
                    ...
                    <?php echo Form::model($user, array('action' => array('SoftDeletesController@update', $user->id), 'method' => 'PUT', 'class' => 'form-inline')); ?>
                        ...
                        <?php echo Form::button('<i class="fa fa-refresh fa-fw" aria-hidden="true"></i> Restore User', array('class' => 'btn btn-success btn-block btn-sm mt-1 mb-1', 'type' => 'submit', 'data-toggle' => 'tooltip', 'title' => 'Restore User')); ?>
