...
<?php $__env->startSection('content'); ?>
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-12">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number"> <?php echo e($clientes->count()); ?> </span>
                </div>
                <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
            ...
            <div class="col-md-3 col-sm-6 col-12">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number"> <?php echo e($sells->count()); ?> </span>
                </div>
                <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
            ...
            <div class="col-md-3 col-sm-6 col-12">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number"> <?php echo e($simbol); ?> <?php echo e(number_format($total,2,".",",")); ?> </span>
                </div>
                <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
        ...
        <div class="row">
            <div class="col-12 col-lg-8">
                <?php echo $__env->make('panels.estadistica-panel', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </div>
            <div class="col-12 col-lg-4">
                <?php echo $__env->make('panels.buyup-panel', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </div>
        </div>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('footer_scripts'); ?>
<!-- Scripts Extras -->
<?php echo e(HTML::script('https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.7.2/Chart.js')); ?>
