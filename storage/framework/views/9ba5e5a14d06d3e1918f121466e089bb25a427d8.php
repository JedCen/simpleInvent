                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <a href="<?php echo e(url('/themes/' . $theme->id)); ?>" class="btn btn-light btn-sm float-right" data-toggle="tooltip" data-placement="top" title="<?php echo e(app('translator')->getFromJson('themes.backToThemeTt')); ?>">
                                <i class="fa fa-fw fa-mail-reply" aria-hidden="true"></i>
                                <?php echo e(app('translator')->getFromJson('themes.backToThemeBtn')); ?>
                            </a>
