          ...
          <div class="card-header text-white @if ($user->activated == 1) bg-success @else bg-danger @endif">
            <div style="display: flex; justify-content: space-between; align-items: center;">
              ...
              <div class="float-right">
                <a href="{{ route('users') }}" class="btn btn-info btn-sm float-right" data-toggle="tooltip" data-placement="left" title="{!! trans('usersmanagement.tooltips.back-users') !!}">
                ...
                @if ($user->profile)
                  <div class="text-center text-left-tablet mb-4">
                    ...
                    <a href="/users/{{$user->id}}/edit" class="btn btn-sm btn-warning" data-toggle="tooltip" data-placement="top" title="{{ trans('usersmanagement.editUser') }}">
                      <i class="fas fa-pencil-alt fa-fw" aria-hidden="true"></i> <span class="hidden-xs hidden-sm hidden-md"> {{ trans('usersmanagement.editUser') }} </span>
                    </a>
